...
if [[ $status -gt 0 ]]
    ...
    eksctl create cluster --name capstone --region $AWS_DEFAULT_REGION --version 1.20  --nodegroup-name capstone-ng --node-type t3.large --nodes-min 2 --nodes-max 2 --managed
